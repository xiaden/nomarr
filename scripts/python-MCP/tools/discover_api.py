...
Usage:
    # Standalone
    python scripts/mcp/tools/discover_api.py myapp.services.database

    # As module
    from scripts.mcp.tools.discover_api import discover_api
    result = discover_api("myapp.services.database")
"""
...
def discover_api(module_name: str, *, include_docstrings: bool = True, max_doc_lines: int = 1) -> dict[str, Any]:
    ...
    Args:
        module_name: Fully qualified module name (e.g., 'myapp.services.database')
...
def main() -> int:
    ...
    parser.add_argument("module", help="Module name (e.g., myapp.services.database)")
