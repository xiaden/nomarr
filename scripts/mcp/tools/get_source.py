...
def _find_symbol_in_ast(
    tree: ast.Module, symbol_path: list[str],
...
def get_source(qualified_name: str, *, large_context: bool = False) -> dict[str, Any]:
...
def main() -> int:
    ...
    result = get_source(args.name, large_context=args.large_context)
