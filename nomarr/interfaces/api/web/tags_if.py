...
async def web_show_tags(
    ...
    try:
        ...
        tags = await asyncio.to_thread(tagging_service.read_file_tags, path, namespace)
...
async def web_remove_tags(
    ...
    try:
        namespace = tagging_service.namespace
        count = await asyncio.to_thread(tagging_service.remove_file_tags, path, namespace)
