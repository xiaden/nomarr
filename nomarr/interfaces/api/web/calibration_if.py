...
async def apply_calibration_to_library(
    tagging_service: Annotated[Any, Depends(get_tagging_service)],
) -> ApplyCalibrationResponse:
    ...
    try:
        ...
        logging.exception(f"[Web API] Tagging service error: {e}")
...
async def get_calibration_history_single(
    ...
    """
    try:
        return calibration_service.get_calibration_history(
