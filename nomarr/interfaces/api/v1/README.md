...
- Provide Navidrome integration endpoints (similar tracks, playlist generation)
...
## Key Modules
 ...
 | `admin_if.py` | Worker pause/resume, calibration trigger (3 endpoints) |
  | `navidrome_v1_if.py` | Similar tracks via ANN search, playlist generation (2 endpoints) |
...
- **Request/response models**: Navidrome endpoints define inline Pydantic models (`SimilarTracksRequest`, etc.) alongside the route handlers
