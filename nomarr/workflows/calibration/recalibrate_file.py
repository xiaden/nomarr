...
from nomarr.components.ml.models.discovery import HeadOutput, discover_heads
from nomarr.components.tagging.aggregation import aggregate_mood_tiers, load_calibrations
    ...
    for tag_key, value in numeric_tags.items():
        ...
        if head_info.is_mood_source or head_info.is_regression_mood_source:
            ...
            if calibrations and clean_key in calibrations:
                from nomarr.components.ml.calibration import apply_minmax_calibration
