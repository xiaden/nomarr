...
- `db: Database | None` - Optional database instance for library updates
  - If provided, must support: db.library_files.*, db.library_tags.*, db.conn
...
from nomarr.components.ml.inference import compute_embeddings_for_backbone, make_head_only_predictor_batched
from nomarr.components.ml.models.discovery import HeadInfo, discover_heads
from nomarr.components.ml.models.embed import pool_scores
from nomarr.components.ml.models.heads import run_head_decision
from nomarr.components.tagging.aggregation import (
...
def process_file_workflow(
    ...
    """
    from nomarr.components.ml.cache import check_and_evict_idle_cache, touch_cache
