...
def generate_calibration_workflow(
    ...
    for head_key, head_data in head_results.items():
        ...
        reference = db.calibration.get_reference_calibration_run(model_name, head_name)
        ...
        db.calibration.insert_calibration_run(
            model_name=model_name,
            head_name=head_name,
...
def _get_next_version(db: Database) -> int:
    ...
    """
    all_runs = db.calibration.list_calibration_runs(limit=10000)
