...
- db.library.upsert_library_file(path, **metadata) -> int
- db.library.get_library_file(path) -> dict | None
- db.queue.enqueue(path, force) -> int
        ...
        if auto_tag:
            ...
            if file_record:
                ...
                if needs_tag and ignore_patterns:
                    from nomarr.workflows.start_library_scan import _matches_ignore_pattern
