...
def make_predictor_uncached(head_info: HeadInfo) -> Callable[[np.ndarray, int], np.ndarray]:
    ...
    from nomarr.components.ml.models.discovery import get_embedding_output_node, get_head_output_node
...
def compute_embeddings_for_backbone(
    ...
    from nomarr.components.ml.audio import load_audio_mono, should_skip_short
...
def make_head_only_predictor_batched(
    ...
    from nomarr.components.ml.models.discovery import get_head_output_node
