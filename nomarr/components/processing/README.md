...
- Batch-write mood tags across multiple files in minimal database round-trips
...
- **Batch optimization:** `save_mood_tags_batch` collapses N files × 3 tiers into 3 SQL queries total via `set_song_tags_batch`.
