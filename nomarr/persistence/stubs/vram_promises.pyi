...
class VramPromisesNamespace(Protocol):
    ...
    worker_id: FieldAccessorProtocol
    pid: FieldAccessorProtocol
    model_path: FieldAccessorProtocol
    promised_mb: FieldAccessorProtocol
    total_mb: FieldAccessorProtocol
    used_mb: FieldAccessorProtocol
    last_seen_ms: FieldAccessorProtocol
