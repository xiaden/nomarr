...
class LibraryScansNamespace(Protocol):
    ...
    files_processed: FieldAccessorProtocol
    files_total: FieldAccessorProtocol
    completed_at: FieldAccessorProtocol
    started_at: FieldAccessorProtocol
    error: FieldAccessorProtocol
    scan_type: FieldAccessorProtocol
