...
class SegmentScoresStatsNamespace(Protocol):
    ...
    head_name: FieldAccessorProtocol
    tagger_version: FieldAccessorProtocol
    num_segments: FieldAccessorProtocol
    pooling_strategy: FieldAccessorProtocol
    label_stats: FieldAccessorProtocol
    processed_at: FieldAccessorProtocol
