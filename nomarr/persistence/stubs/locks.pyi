...
class LocksNamespace(Protocol):
    ...
    document_reference: FieldAccessorProtocol
    lock_type: FieldAccessorProtocol
    expires_at: FieldAccessorProtocol
    acquired_at: FieldAccessorProtocol
    holder: FieldAccessorProtocol
