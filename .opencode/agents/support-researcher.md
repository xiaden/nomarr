...
1. **Start broad** — Use `read_module_api`, glob for directory structure
2. **Trace relationships** — Use `locate_module_symbol` and `read_module_source` to follow code paths
