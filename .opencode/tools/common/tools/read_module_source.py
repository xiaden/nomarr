...
from common.helpers.config_loader import get_workspace_root, resolve_module_path
from common.helpers.file_lines import read_raw_line_range
...
if __name__ == "__main__":
    ...
    result = read_module_source(
        ...
        large_context=raw.get("large_context", False),
    )
