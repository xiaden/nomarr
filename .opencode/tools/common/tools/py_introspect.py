...
CheckUnion = MroCheck | IsSubclassCheck | SignatureCheck | DocCheck | GetsourceContainsCheck | AstRaisesCheck
...
def py_introspect(
    ...
    return {
        ...
        "title": "Py Introspect",
        "metadata": {"imports": len(imports) if imports else 0, "checks": len(checks) if checks else 0},
    }
...
if __name__ == "__main__":
    ...
    result = py_introspect(
        ...
        max_source_chars=raw.get("max_source_chars", 2000),
    )
