                ...
                if imports_block_end >= start:
                    ...
                    result: dict = {
                        ...
                        "imports": {
                            ...
                            "start": 1,
                            "end": imports_block_end,
                        },
                        "requested": {"content": main_content, "start": start, "end": end},
                    }
                    result["warning"] = (
                        "WARNING: Reading Python files with read_line wastes tokens and "
                        "loses structure. Use discover_api (module overview), "
                        "locate_symbol (find definitions), or get_symbol_body_at_line "
                        "(get function/class at line) instead."
                    )
                    return result
