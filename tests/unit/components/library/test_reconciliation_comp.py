...
class TestClaimFilesForReconciliation:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_returns_empty_list_when_no_stale_files(self) -> None:
        mock_db = AsyncMock()
...
class TestSetFileWritten:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_normalizes_bare_key_to_full_id(self) -> None:
        mock_db = AsyncMock()
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_normalizes_full_id_unchanged(self) -> None:
        mock_db = AsyncMock()
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_transitions_tag_state_edges(self) -> None:
        mock_db = AsyncMock()
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_releases_claim_via_app_api(self) -> None:
        mock_db = AsyncMock()
...
class TestCountFilesNeedingReconciliation:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_returns_count_of_stale_file_ids(self) -> None:
        mock_db = AsyncMock()
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_returns_zero_when_no_stale_files(self) -> None:
        mock_db = AsyncMock()
