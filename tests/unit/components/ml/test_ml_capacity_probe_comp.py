...
class TestGetOrRunCapacityProbe:
    ...
    def test_returns_cached_estimate_when_exists(self):
        ...
        mock_db.ml_capacity.model_set_hash.get.return_value = cached
...
class TestInvalidateCapacityEstimate:
    ...
    def test_deletes_cached_estimate(self):
        ...
        mock_db.ml_capacity.model_set_hash.delete.assert_called_once_with("abc123")
        mock_db.locks.document_reference.delete.assert_called_once_with("capacity_probe:abc123")
