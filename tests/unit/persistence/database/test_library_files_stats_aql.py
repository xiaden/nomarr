...
class TestCountFilesByTag:
    ...
    def test_returns_int_for_float_target_value(self) -> None:
        ...
        assert result == 1
        mock_db.library_files_aql.count_files_by_tag.assert_called_once_with("nom:bpm", 120.5)
    ...
    def test_treats_integer_target_value_as_numeric_branch(self) -> None:
        ...
        assert result == 1
        mock_db.library_files_aql.count_files_by_tag.assert_called_once_with("nom:rating", 7)
    ...
    def test_treats_bool_target_value_as_string_branch(self) -> None:
        ...
        assert result == 1
        mock_db.library_files_aql.count_files_by_tag.assert_called_once_with("flag", True)
    ...
    def test_returns_zero_when_no_matching_tag_ids(self) -> None:
        ...
        mock_db = MagicMock()
        mock_db.library_files_aql.count_files_by_tag.return_value = 0
