"""Shared PostgreSQL fixtures for repository tests using testcontainers pgvector/pgvector:pg17.

Provides ``pg_engine`` (session-scoped), ``pg_async_engine``, and ``pg_session``
...
# ── PostgreSQL fixtures for Part C repository tests ─────────────
