...
class TestWriteToDb:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_calls_update_config_option_api(self) -> None:
        ...
        with patch("nomarr.services.infrastructure.config_svc.Database") as mock_database:
            ...
            await service._write_to_db("namespace", "myns")
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_closes_connection_after_write(self) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_swallows_exception_on_db_failure(self) -> None:
...
class TestBootstrapAndLoad:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_reads_existing_config_via_list_config_options(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_seeds_missing_key_to_db(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_populates_cache_from_db_values(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    @pytest.mark.unit
    @pytest.mark.mocked
    async def test_falls_back_to_file_config_when_db_unavailable(self, monkeypatch: pytest.MonkeyPatch) -> None:
