# Security, provenance, and rollback evidence (tracked clean-checkout fixture)

This tracked fixture carries only the non-sensitive contract vocabulary that the
security static readers require. It contains no credentials, raw rows, marker
...
that No commit was created. Real execution HEAD values are intentionally absent
from this tracked fixture.
...
4. Restore the complete protected set coherently.
