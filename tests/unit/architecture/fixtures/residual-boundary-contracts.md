# Residual boundary contracts (tracked clean-checkout fixture)

This tracked fixture carries only the non-sensitive contract vocabulary that the
residual contract reader requires. It contains no credentials, raw rows, marker
...
exact owner/boundary allowlist names owner, boundary, reason, test evidence,
