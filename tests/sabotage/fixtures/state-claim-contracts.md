...
claim-owner contract reader requires. It contains no credentials, raw rows, marker
...
identity crossing requires an exact owner/boundary allowlist naming owner, boundary,
