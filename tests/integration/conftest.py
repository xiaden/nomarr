...
# Temp file for the shared SQLite database.  SQLite :memory: databases
# are per-connection, so a temp file is required to share state between
# the DDL (session-scoped) and query (per-test) engines.
