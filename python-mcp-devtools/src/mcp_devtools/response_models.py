...
class AppliedOp(BaseModel):
    ...
    target_filepath: str | None = Field(default=None, description="Target file path (for move operations)")
    target_created: bool | None = Field(default=None, description="Whether target file was created")
    warnings: list[str] | None = Field(default=None, description="Non-fatal warnings for this operation")
