...
# Add package src to sys.path BEFORE imports
...
from mcp_devtools.project_check_api_coverage import project_check_api_coverage
from mcp_devtools.trace_endpoint import trace_endpoint
